...
public class LargeNodeAttributeDpsHandler extends DpsHandler {
    ...
    public ComponentEvent onEvent(final ComponentEvent event) {
        ...
        logger.debug("LargeNodeAttributeDpsHandler header values: {}", event.getHeaders());
        ...
        try {
            ...
            cmFunctionMoDpsOperator.updateAttrsUponSuccessfulSync(cmFunctionFdn, ossPrefix, Boolean.TRUE);
