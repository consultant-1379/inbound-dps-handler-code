...
public class DeltaDpsHandlerInterceptorTest {

    private static final String EXCEPTION_MESSAGE = "DeltaDpsHandlerInterceptorTest Exception Message";
    ...
    @InjectMocks
    private DeltaDpsHandlerInterceptor deltaDpsHandlerInterceptor;
    ...
    @Test
    public void testAddToDpsPersistAttributesAvgTimeSamples() {
        deltaDpsHandlerInterceptor.intercept(mockInvocationContext);
        Mockito.verify(mockInstrumentation).addToDpsPersistAttributesAvgTimeSamples(Matchers.anyLong());
    }
