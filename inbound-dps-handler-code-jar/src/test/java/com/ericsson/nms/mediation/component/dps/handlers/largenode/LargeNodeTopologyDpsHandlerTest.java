...
public class LargeNodeTopologyDpsHandlerTest {
    ...
    @InjectMocks
    private LargeNodeTopologyDpsHandler largeNodeTopologyDpsHandler;
    ...
    public void setUp() throws Exception {
        ...
        initHeaders.put(MiscellaneousConstants.OSS_PREFIX_HEADER_NAME, OSS_PREFIX);
        ...
        handlerHeaders.put(LargeNodeTopologyDpsHandler.class.getCanonicalName(), new HashMap<>());
        ...
        TestUtil.setFieldValue("contextHeaders", mockContextHeaders, LargeNodeTopologyDpsHandler.class, largeNodeTopologyDpsHandler);
        ...
        largeNodeTopologyDpsHandler.init(mockContext);
    ...
    public void testOnEvent() throws Exception {
        ...
        final ComponentEvent resultEvent = largeNodeTopologyDpsHandler.onEvent(mockEvent);
    ...
    public void testOnEvent_PayloadIsException() throws Exception {
        ...
        largeNodeTopologyDpsHandler.onEvent(mockEvent);
    ...
    public void testOnEvent_EventIsNull() throws Exception {
        largeNodeTopologyDpsHandler.onEvent(null);
    }
