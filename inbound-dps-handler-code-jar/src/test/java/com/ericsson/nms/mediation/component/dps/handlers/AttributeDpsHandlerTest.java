...
public class AttributeDpsHandlerTest {
    ...
    @InjectMocks
    private AttributeDpsHandler attributeDpsHandler;
    ...
    public void setUp() throws Exception {
        ...
        attributeDpsHandler.init(contextMock);
    }
    ...
    public void testOnEvent() throws Exception {
        ...
        attributeDpsHandler.onEvent(eventMock);
        verify(attributeWriteDpsOperatorMock).handleAttributesPersistence(eventMock, OSS_PREFIX_HEADER_VALUE, Boolean.FALSE);
        verify(cmFunctionMoDpsOperatorMock).updateAttrsUponSuccessfulSync(CM_FUNCTION_FDN, OSS_PREFIX_HEADER_VALUE, Boolean.FALSE);
    }
    ...
    public void testOnEvent_EventIsNull() throws Exception {
        attributeDpsHandler.onEvent(null);
